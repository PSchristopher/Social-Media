...
function UserList() {
    ...
    return (
        <div className="">
            <p className="flex justify-center pb-2 text-dark-purple text-3xl font-bold  bg-white">User Management</p>
                    ...
                    {users?.map((user, i) => {
                        ...
                        return (
                            <tr key={i} className='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
                                ...
                                <td className='py-4 px-6'>{user.fullname} || {user.UserName}</td>
