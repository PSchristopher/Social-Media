                ...
                <div class=" inline-flex items-center justify-center flex-shrink-0">
                  {
                    UserDetails.image ?
                      ...
                      <img src={PF + UserDetails.image} alt="ProfileImage" className="rounded-full w-36 h-36 " />
                      :
                      ...
                      return (
                        <div className='relative ' >
                          <div className='myDIV  '>
                            ...
                            <img src={PF + UserPosts.image} alt="POST" className='rounded-lg h-80 border-2 border-blue-400 w-full  object-cover' />
